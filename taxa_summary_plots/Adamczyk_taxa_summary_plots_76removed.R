...
# Purpose: taxa summary plots wih 76 samples removed (Fig. 5 and Fig. S1 in supplementary analyses)
...
taxonomy_plot_obj <- readRDS("Adamczyk_taxa_summary_plots_76_samples_removed.RDS")
...
# Day 1 natural eelgrass (rank 6)
colnames(new_i_c) <- c("Saprospiraceae; uncultured", #12
                       ...
                       "Flavobacteriaceae; Winogradskyella", #43  
                       "Rhodobacteraceae; Pseudooctadecabacter", #58
                       "Rhodobacteraceae; Loktanella",  #14
                       "Pirellulaceae; Blastopirellula",   #138
                       "Flavobacteriaceae; Polaribacter",#9
                       "Flavobacteriaceae; Maribacter",  #45
                       "Microtrichaceae; uncultured", #164
                       "Rickettsiaceae; Rickettsia", #152
                       "Thiotrichaceae; Cocleimonas", #36
                       "Rhizobiaceae; Lentilitoribacter", #46  <-  THIS IS NEW??>
                       "Others")
...
# selecting Day 5 natural seagrass
  ...
  # Day 5 natural eelgrass (rank 6)
  colnames(new_f_c) <- c("Saprospiraceae; uncultured",	#12				
                         "Rhodobacteraceae; Sulfitobacter", #8					
                         "Methylophilaceae; Methylotenera", #4					
                         "Methylophilaceae; Methylophilus",	#7				
                         "Thiohalorhabdaceae; Granulosicoccus", #26 					
                         ...
                         "Rhodobacteraceae; Loktanella",	 #14				
                         "Thiotrichaceae; Cocleimonas",	#36				
                         "Thiotrichaceae; Leucothrix",	#33				
                         "Flavobacteriaceae; Maribacter", #45					
                         "Verrucomicrobiales; DEV007; uncultured", #118
                         "Pirellulaceae; Blastopirellula",	#138	
                         "Flavobacteriaceae; uncultured",	#88	
                         "Flavobacteriaceae; Winogradskyella",  #58	
                         "Hyphomonadaceae; Litorimonas", #96			<-  MAYBE NEW??		
                         "Others")	
  ...
  new_f_c$origin_site <- sample_data(final_control_only)$origin_site[which(row.names(sample_data(final_control_only)) %in% row.names(new_f_c))]
  new_f_c$sample_id <- row.names(new_f_c)
  new_fc_melt <- reshape2::melt(new_f_c, id.vars = c("sample_id", "origin_site"), variable = "Taxa", na.rm=TRUE)
...
# filtering for sterilized eelgrass only
  ...
  colnames(new_f_s) <- c("Rhodobacteraceae; Sulfitobacter", #8
                         "Rhodobacteraceae; Pacificibacter", #15
                         "Saprospiraceae; uncultured", #12
                         "Rhodobacteraceae; Loktanella", #14
                         "Thiotrichaceae; Leucothrix", #33
                         "Alteromonadaceae; Alteromonas",#16
                         "Colwelliaceae; Colwellia", #62
                         "Methylophilaceae; Methylophilus", #7
                         "Methylophilaceae; Methylotenera", #4
                         "Thiotrichaceae; Cocleimonas", #36
                         "Flavobacteriaceae; Polaribacter", #9
...
# RANK 6 - ASU final
colnames(new_f_asu) <- c("Rhodobacteraceae; Sulfitobacter",  #8
                         "Saprospiraceae; uncultured", #12
...
# sterilized Day 1 eelgrass only
  ...
  colnames(new_i_s) <- c("Alteromonadaceae; Alteromonas", #16
                         ...
                         "Saprospiraceae; uncultured",#12
                         "Rhodobacteraceae; Loktanella", #14
                         "Hyphomicrobiaceae; Hyphomicrobium", #1219 <- NEWWWWWWWW
                         "Cryomorphaceae; uncultured", #369  <- NEWWWWWWWW
                         "Arcobacteraceae; Arcobacter", #457 <- NEWWWWWWW
                         "Others")
