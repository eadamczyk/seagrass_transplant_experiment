...
# Purpose: IndVal (indicator species analysis) for Rank 6 abundance for ALL SAMPLES (Table 3)
...
seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.otu <- read.csv("seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.otu.csv")
...
seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam <- read.csv("seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam.csv") 


# merging sam and otu tables together
seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.otu <- seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.otu %>% 
  dplyr::rename(sample_id = X)

# removing unnecessary columns
seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam <- seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam[-c(1, 3:13, 15:16)]
...
names(seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam)
seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$transplant_type = NA

# initial
seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$transplant_type[seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$treatment == "control" & seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$category == "initial_eelgrass_swab"] <- "initial"

# replant
seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$transplant_type[as.character(seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$origin_site) == as.character(seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$destination) & seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$treatment == "control" & seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$category == "final_eelgrass_swab"] <- "replant"

# transplant
seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$transplant_type[as.character(seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$origin_site) != as.character(seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$destination) & seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$treatment == "control" & seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam$category == "final_eelgrass_swab"] <- "transplant"
...
meta_otu <- left_join(seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.sam, seagrass_transplant_16s_NOT_RAREFIED_RANK_6_all_samples.otu, by = "sample_id")
